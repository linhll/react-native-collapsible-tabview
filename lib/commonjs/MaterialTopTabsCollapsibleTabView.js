...
exports.default = MaterialTopTabsCollapsibleTabView;

var React = _interopRequireWildcard(require("react"));

var _native = require("@react-navigation/native");

var _CollapsibleTabView = _interopRequireDefault(require("./CollapsibleTabView"));
...
function MaterialTopTabsCollapsibleTabView({
  pager,
  lazyPlaceholder,
  tabBar = props => /*#__PURE__*/React.createElement(_materialTopTabs.MaterialTopTabBar, props),
  tabBarOptions,
  state,
  navigation,
  descriptors,
  ...
  return /*#__PURE__*/React.createElement(_native.NavigationHelpersContext.Provider, {
    value: navigation
  }, /*#__PURE__*/React.createElement(_CollapsibleTabView.default, _extends({}, collapsibleOptions, rest, {
    routeKeyProp: "name",
